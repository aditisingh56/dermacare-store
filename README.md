...
1. BACKEND INITIALIZATION (Spring Boot)
   ...
   - Run the database seed queries provided to initialize tables.
   - Run the main Spring Boot Application file. The server will 
     boot up on http://localhost:8080.

2. FRONTEND INITIALIZATION (React Vite SPA)
   - Open a command terminal inside the frontend directory.
